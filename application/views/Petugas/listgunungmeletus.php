  ...
  <ul class="pagination justify-content-center">
   ...
   <li class="page-item active"><a class="page-link" href="<?php echo site_url('Petugas/listgunungmeletuspetugas') ?>">Gunung Meletus</a>
    </li>
    ...
    <li class="page-item"><a class="page-link" href="<?php echo site_url('Petugas/listkekeringanpetugas')?>">Kekeringan</a>
    </li>
        ...
        <div class="col-sm-12"> 
         ...
         <?php foreach ($bencanagunung->result() as $key) { ?>
          ...
          <div class="list-group">
            <a href="<?php echo site_url('Petugas/rincianpetugas/'.$key->id_bencana)?>" class="list-group-item list-group-item-action"> <?php echo $key->nama_bencana;?></a>

...
<section class="about " id="about" style="border:0">
      <div class="container " >
        ...
        <a href="<?php echo site_url('Umum/rincian/'.$key->id_bencana)?>"><img class="card-img-top " src="<?php echo base_url();?>fotobencana/<?php echo $key->foto ?>" alt="Card image cap"></a>
        <div class="card-body">
            <a href="<?php echo site_url('Umum/rincian/'.$key->id_bencana)?>"> <?php echo $key->nama_bencana;?></a>
           ...
           <div class="row" style="padding-left: 290px;">
            <p class="text-right"><a href="<?php echo site_url('Login/index')?>"  style="background-color: #29a3db; border-color: #caebf2; color: white; font-weight: bold;" class="btn btn-success" >Donasi</a></p></div>
        </div>
         <?php }?>
